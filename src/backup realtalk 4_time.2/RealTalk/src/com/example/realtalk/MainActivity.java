...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button createMsg = (Button) findViewById(R.id.composeBtn);
		
		createMsg.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				Toast.makeText(getBaseContext(), "Create Message", Toast.LENGTH_LONG).show();
				Intent gotocomposeMsg = new Intent(MainActivity.this, ComposeActivity.class );
				startActivity(gotocomposeMsg);
